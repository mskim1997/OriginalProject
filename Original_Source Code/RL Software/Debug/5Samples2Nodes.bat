@echo off
echo One Agent
for %%a in (1 2 3 4 5) do mpiexec -np 3 MazeService.exe -m maze_12x8.in -x 8 -y 12 -a 1 -o StatsFileOneAgent%%a.csv -i AgentInfo.txt -s true -h false

echo Five Agents Sharing

for %%a in (1 2 3 4 5) do mpiexec -np 3 MazeService.exe -m maze_12x8.in -x 8 -y 12 -a 5 -o StatsFileFiveAgentSharing%%a.csv -i AgentInfo.txt -s true -h false

echo Five Agents No sharing

for %%a in (1 2 3 4 5) do mpiexec -np 3 MazeService.exe -m maze_12x8.in -x 8 -y 12 -a 5 -o StatsFileFiveAgent%%a.csv -i AgentInfo.txt -s false -h false
