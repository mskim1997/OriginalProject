...
namespace MLContinuous
{
	...
	public:
		...
		virtual void NotifyAgentIsDone(unsigned agentId, int totalNumSteps, float minRadius, int xPos = 0, int yPos = 0, bool isTransferedAgent = false, bool hasFoundGoal = true, unsigned transferId = 0) = 0;
	};
}
